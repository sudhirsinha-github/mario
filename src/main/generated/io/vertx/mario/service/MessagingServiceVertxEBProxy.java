...
public class MessagingServiceVertxEBProxy implements MessagingService {
  ...
  public MessagingServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MessagingServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public MessagingService sendMail(MailMessage mailMessage, Handler<AsyncResult<MailResult>> resultHandler) {
    ...
    _json.put("mailMessage", mailMessage == null ? null : mailMessage.toJson());
