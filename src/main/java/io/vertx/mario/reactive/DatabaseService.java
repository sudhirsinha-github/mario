...
@io.vertx.lang.reactivex.RxGen(io.vertx.mario.service.DatabaseService.class)
public class DatabaseService {
	...
	public static final io.vertx.lang.reactivex.TypeArg<DatabaseService> __TYPE_ARG = new io.vertx.lang.reactivex.TypeArg<>(
			obj -> new DatabaseService((io.vertx.mario.service.DatabaseService) obj), DatabaseService::getDelegate);

	private final io.vertx.mario.service.DatabaseService delegate;

	public DatabaseService(io.vertx.mario.service.DatabaseService delegate) {
		this.delegate = delegate;
	}

	public io.vertx.mario.service.DatabaseService getDelegate() {
		return delegate;
	}
	...
	public static DatabaseService create(MongoClient mongoClient,
			Handler<AsyncResult<io.vertx.mario.service.DatabaseService>> readyHandler) {
		DatabaseService ret = DatabaseService
				.newInstance(io.vertx.mario.service.DatabaseService.create(mongoClient, readyHandler));
		return ret;
	}

	public static DatabaseService createProxy(Vertx vertx, String address) {
		DatabaseService ret = DatabaseService
				.newInstance(io.vertx.mario.service.DatabaseService.createProxy(vertx.getDelegate(), address));
		return ret;
	}
}