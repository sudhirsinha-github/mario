package io.vertx.mario.reactive;
...
@io.vertx.lang.reactivex.RxGen(io.vertx.mario.service.MessagingService.class)
public class MessagingService {
	...
	public static final io.vertx.lang.reactivex.TypeArg<MessagingService> __TYPE_ARG = new io.vertx.lang.reactivex.TypeArg<>(
			obj -> new MessagingService((io.vertx.mario.service.MessagingService) obj),
			MessagingService::getDelegate);

	private final io.vertx.mario.service.MessagingService delegate;

	public MessagingService(io.vertx.mario.service.MessagingService delegate) {
		this.delegate = delegate;
	}

	public io.vertx.mario.service.MessagingService getDelegate() {
		return delegate;
	}
	...
	public static MessagingService newInstance(io.vertx.mario.service.MessagingService arg) {
		return arg != null ? new MessagingService(arg) : null;
	}

	public static MessagingService create(MailClient mailClient,
			Handler<AsyncResult<io.vertx.mario.service.MessagingService>> readyHandler) {
		MessagingService ret = MessagingService
				.newInstance(io.vertx.mario.service.MessagingService.create(mailClient, readyHandler));
		return ret;
	}

	public static MessagingService createProxy(Vertx vertx, String address) {
		MessagingService ret = MessagingService
				.newInstance(io.vertx.mario.service.MessagingService.createProxy(vertx.getDelegate(), address));
		return ret;
	}
}