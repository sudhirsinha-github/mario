...
import io.vertx.mario.annotation.AnnotationProcessor;
import io.vertx.mario.handler.ErrorHandler;
import io.vertx.mario.helper.ConfigHelper;
import io.vertx.mario.helper.DatabaseServiceHelper;
import io.vertx.mario.helper.HttpClientHelper;
	...
	public void start(Future<Void> startFuture) {
		try {
			...
			DatabaseServiceHelper.INSTANCE.setDbService(
					DatabaseService.createProxy(vertx, io.vertx.mario.service.DatabaseService.DEFAULT_ADDRESS));
			MessageServiceHelper.INSTANCE.setMessageService(
					MessagingService.createProxy(vertx, io.vertx.mario.service.MessagingService.DEFAULT_ADDRESS));
